...
import com.ibm.watson.developer_cloud.discovery.v1.model.document.UpdateDocumentRequest.Builder;
...
//	private static final String SELECT_ITEM_EXPLANATION = "おすすめのプラン";
	...
	public String teachItem(Map<String, String> eventMap, String imgDir) {
		...
		if (text.equals(SELECT_PLAN_EXPLANATION)) {
			mesJab.add(MessageAPIUtil.giveMessage("おすすめのプランですね。\\nお好みのプランはありますか？"));
// TEST START
		System.out.println("---------- Logic 2. ----------");
	    /** text to speech 試し */
		    TextToSpeech service = new TextToSpeech();
		    service.setUsernameAndPassword("4b942180-9c14-4158-9224-29c8310833d9",
		             "HbPRkBDyJiDo");
		System.out.println("---------- Logic 3. ----------");

// 		    try {
// 		System.out.println("---------- Logic 41. ----------");
// 		    String text1 = "Hello world";
// 		    InputStream stream = service.synthesize(text1, Voice.EN_ALLISON,
...
// 		    }
		    ...
		    Pronunciation pronunciation = service.getPronunciation("IEEE",Voice.EN_ALLISON,Phoneme.SPR).execute();
		  //  Pronunciation pronunciation = service.getPronunciation("テスト"
		  //           Voice.JA_EMI,Phoneme.SPR).execute();
		System.out.println("---------- Logic 4. ----------");
		...
		System.out.println("---------- Logic 5. ----------");
			...
			baseSize1.add(LINEConstants.HEIGHT, 260);
...
// 					0, 65, 130));
			actions1.add(giveUrl4IM(Constants.IMG_URL
					+ "imapemap_plan0002", 0,
					0, 1040, 130));
			...
			JsonObjectBuilder imagemap2 = Json.createObjectBuilder();
			imagemap2.add(LINEConstants.TYPE, LINEConstants.IMAGEMAP);
			imagemap2.add(LINEConstants.BASEURL, Constants.IMG_URL
					+ "imapemap_plan0002");
			imagemap2.add("altText", "イメージマップだよ");
			JsonObjectBuilder baseSize2 = Json.createObjectBuilder();
			baseSize2.add(LINEConstants.WIDTH, 1040);
			baseSize2.add(LINEConstants.HEIGHT, 260);
			imagemap2.add("baseSize", baseSize2);
			JsonArrayBuilder actions2 = Json.createArrayBuilder();
			// 左下
			actions2.add(giveMes4IM(DFLConstants.FIXED_ANNUITY_INSURANCE, 0,
					0, 65, 130));
			imagemap2.add(LINEConstants.ACTIONS, actions2);
			mesJab.add(imagemap2);
			// ------------------------------------------------------------------------------
			// ------------------------------------------------------------------------------
			// プラン0003
			// ------------------------------------------------------------------------------

			JsonObjectBuilder imagemap3 = Json.createObjectBuilder();
			imagemap3.add(LINEConstants.TYPE, LINEConstants.IMAGEMAP);
			imagemap3.add(LINEConstants.BASEURL, Constants.IMG_URL
					+ "imapemap_plan0003");
			imagemap3.add("altText", "イメージマップだよ");
			JsonObjectBuilder baseSize3 = Json.createObjectBuilder();
			baseSize3.add(LINEConstants.WIDTH, 1040);
			baseSize3.add(LINEConstants.HEIGHT, 260);
			imagemap3.add("baseSize", baseSize3);
			JsonArrayBuilder actions3 = Json.createArrayBuilder();
			// 左下
			actions3.add(giveMes4IM(DFLConstants.FIXED_ANNUITY_INSURANCE, 0,
					0, 65, 130));
			imagemap3.add(LINEConstants.ACTIONS, actions3);
			mesJab.add(imagemap3);
			// ------------------------------------------------------------------------------
// 			// ------------------------------------------------------------------------------
// 			// プラン0004
// 			// ------------------------------------------------------------------------------

// 			JsonObjectBuilder imagemap4 = Json.createObjectBuilder();
// 			imagemap4.add(LINEConstants.TYPE, LINEConstants.IMAGEMAP);
// 			imagemap4.add(LINEConstants.BASEURL, Constants.IMG_URL
// 					+ "imapemap_plan0004");
// 			imagemap4.add("altText", "イメージマップだよ");
// 			JsonObjectBuilder baseSize4 = Json.createObjectBuilder();
// 			baseSize4.add(LINEConstants.WIDTH, 1040);
// 			baseSize4.add(LINEConstants.HEIGHT, 260);
// 			imagemap4.add("baseSize", baseSize4);
// 			JsonArrayBuilder actions4 = Json.createArrayBuilder();
// 			// 左下
// 			actions4.add(giveMes4IM(DFLConstants.FIXED_ANNUITY_INSURANCE, 0,
// 					0, 65, 130));
// 			imagemap4.add(LINEConstants.ACTIONS, actions4);
// 			mesJab.add(imagemap4);
			// ------------------------------------------------------------------------------
// 			// ------------------------------------------------------------------------------
// 			// プラン0005
// 			// ------------------------------------------------------------------------------

// 			JsonObjectBuilder imagemap5 = Json.createObjectBuilder();
// 			imagemap5.add(LINEConstants.TYPE, LINEConstants.IMAGEMAP);
// 			imagemap5.add(LINEConstants.BASEURL, Constants.IMG_URL
// 					+ "imapemap_plan0005");
// 			imagemap5.add("altText", "イメージマップだよ");
// 			JsonObjectBuilder baseSize5 = Json.createObjectBuilder();
// 			baseSize5.add(LINEConstants.WIDTH, 1040);
// 			baseSize5.add(LINEConstants.HEIGHT, 260);
// 			imagemap5.add("baseSize", baseSize5);
// 			JsonArrayBuilder actions5 = Json.createArrayBuilder();
// 			// 左下
// 			actions5.add(giveMes4IM(DFLConstants.FIXED_ANNUITY_INSURANCE, 0,
// 					0, 65, 130));
// 			imagemap5.add(LINEConstants.ACTIONS, actions5);
// 			mesJab.add(imagemap5);
// 			// ------------------------------------------------------------------------------
...
// TEST END
		 	...
		 	mesJab.add(MessageAPIUtil.giveMessage("備前焼体験ですね。私も備前焼は大好きです。\\n備前焼に関するおすすめの体験は以下になります。\\どちらからご案内しましょうか？"));
			// ------------------------------------------------------------------------------
			// プラン0101
			// ------------------------------------------------------------------------------
...
//			mesJab.add(makeCarousel5BItem());
			...
			mesJab.add(MessageAPIUtil.giveMessage("ニュースですね。\\n気になるニュースを選んでください"));
...
//			  !text.equals(SELECT_PLAN1_EXPLANATION)) {
				if ("0000003".equals(nlcResults[i]) )  {
			// ------------------------------------------------------------------------------
			// 表情0001 考え中
			// ------------------------------------------------------------------------------
			...
			JsonObjectBuilder baseSize1 = Json.createObjectBuilder();
			baseSize1.add(LINEConstants.WIDTH, 1040);
			baseSize1.add(LINEConstants.HEIGHT, 670);
			imagemap1.add("baseSize", baseSize1);
			JsonArrayBuilder actions1 = Json.createArrayBuilder();
			// 左下
			actions1.add(giveMes4IM(DFLConstants.FIXED_ANNUITY_INSURANCE, 0,
			...
			mesJab.add(imagemap1);
				// mesJab.add(makeCarousel1Item());
       			} else if  ("0000005".equals(nlcResults[i]) )  {
			// ------------------------------------------------------------------------------
			// 表情0002 アップ
			// ------------------------------------------------------------------------------
			...
			mesJab.add(imagemap1);
				// mesJab.add(makeCarousel1Item());
       			} else if  ("0000009".equals(nlcResults[i]) )  {
			// ------------------------------------------------------------------------------
			// 表情0003　笑顔
			// ------------------------------------------------------------------------------
			...
			mesJab.add(imagemap1);
				// mesJab.add(makeCarousel1Item());
       			} else if  ("0000002".equals(nlcResults[i]) )  {
			// ------------------------------------------------------------------------------
			// 表情0004 考え中
			// ------------------------------------------------------------------------------
...
//}
	 ...
	 * @return regionオブジェクト
	 */
	private JsonObjectBuilder giveUrl4IM(String url, int x, int y, int height,
			int width) {
		JsonObjectBuilder region = Json.createObjectBuilder();
		region.add(LINEConstants.TYPE, LINEConstants.URI);
		region.add("linkUri", url);
		JsonObjectBuilder area = Json.createObjectBuilder();
		area.add(LINEConstants.X, x);
		area.add(LINEConstants.Y, y);
		area.add(LINEConstants.HEIGHT, height);
